...
OBS! I THINK THE PART BELOW NEEDS TO HAVE .txt IN ORDER TO WORK. I THINK WE NEED TO FOLLOW THE SAME LOGIC AS THE PLOT_1 BELOW THAT IS WORKING. I WILL TRY TO FIX THIS LATER TODAY OR TOMORROW TO HELP YOU GUYS.

```{r message=FALSE, warning=FALSE, echo=FALSE}

library(here)

source(here("data", "tidy_exam_data_2025-09-08.txt"))

source(here("data", "tidy_exam_data_2025-09-09.txt"))
source(here("data", "joint_exam_data_data-2025-09-09.txt"))
...
```{r include=FALSE}
library(here)
source(here("scripts", "Script_sixthday_2025-11-09.R"))
```
