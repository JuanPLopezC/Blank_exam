...
We were given a database from the source: Cata et al. ’Blood Storage Duration and Biochemical Recurrence of Cancer after Radical Prostate ctomy’. Mayo Clin Proc 2011; 86(2): 120-127. A clean version is taken from R package medicaldata.
...
We had different tasks to develop based on this database and the new skills learned from R. In the following sections, we describe our work to fulfill these tasks. We hope you enjoy it.

```{r setup, include=FALSE}
knitr::opts_chunk$set(echo = TRUE)
```

##Tidying the data The datasett contained oirginally 672 rows for 316 IDs and 21 variables.
...
Then we tidyed the variables, by making new, more intuitive names fore thoose laking of one. Columns containing information concerning two variables were either separated (Subject-\> Hospital and ID ) or splitt through pivot wider as mentioned. Columns listed in the assignmet as not of interest was deleted, as asked for in the task. Columns were then sorted with ID first.
