...
We continued tidying our data set. Further on we made new variables to filter and explore the datasett. For instance PVol_High as categorical varible ( \>/\< 100 ml) 
...
Afterwards, when looking over va our variables, we needed to redo som of the steps
...
-we wanted tidy the variable Hosp, deleting characteters and keeping the numer (1-3) of the treating hospital.
...
skim(joint_exam_data)
```
Further more, we began exploring our variables in daitail, based on the following instructions:
