...
We continued our journey learning about the most useful packages in the R world. We must admit these were first our worst enemies but ended up being friends and allies in this trip. Here an overview.
...
We continued tidying our data set. Further on we made new variables to filter and explore the dataset. For instance PVol_High as categorical variable ( \>/\< 100 ml) 
...
Afterwards, when looking over our variables, we needed to redo som of the steps
...
-we wanted tidy the variable Hosp, deleting characteters and keeping the number (1-3) of the treating hospital.
...
Furthermore, we began exploring our variables in detail, based on the following instructions:
