...
## Anders 2 ----
### Task: Stratify your data by a categorical column and report min, max, mean and sd of a numeric column ----
...
## Anders 3 ----
## Exercise: Use two categorical columns in your dataset to create a table (either with table(), count(), or janitor::tabyl()) ----
